...
![](../images/K-means_convergence.gif){fig-cap="K-means: Konvergenz (animiert, nur HTML)"}
:::

::: {.content-visible when-format="pdf"}
![](../images/K-means_convergence.png){fig-cap="K-means: Konvergenz (statischer Frame für PDF)"}
:::
