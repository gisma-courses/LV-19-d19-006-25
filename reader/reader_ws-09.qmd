...
# 1. Conceptual background and problem framing
...
![Fig. 1: Design framework for the Burgwald rainfall gauge network](../images/Diagram.drawio.svg)  
---

# 2. Catchment-based versus segment-based design

## 2.1 Catchment-based design
...
## 3.1 Structural landscape stratification
...
## 3.3 Adaptive segmentation and scale discovery
...
## 3.4 Segmentation transfer and physiographic strata
...
## 3.5 Hydrological context and network optimisation
