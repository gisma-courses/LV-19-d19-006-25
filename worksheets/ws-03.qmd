---
title: "Core Module Project Organization & Reproducible Setup"
...
The next session (Module 2) will assume that **all groups can load at least one DGM file and one RADOLAN file from `data/raw`** using `here::here()`.
